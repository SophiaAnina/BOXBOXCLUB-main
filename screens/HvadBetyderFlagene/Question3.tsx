...
export default function Question3() {
  ...
  const totalQuestions = 5; // Assuming there are 3 questions in total
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={() => navigation.navigate('Question2')} style={styles.backButton}>
      ...
      <View style={styles.Spørgsmål}>
        <Text style={styles.questionTitle}>Spørgsmål 3</Text>
        <Text style={styles.questionText}>Hvad betyder et blåt flag, når det vises til en kører?</Text>
      </View>
      <View style={styles.Questions}>
        {[
          { text: "Løbet stoppes", isCorrect: false },
          { text: " Kørerne må overhale", isCorrect: false },
          { text: "Køreren bliver overhalet og skal give plads", isCorrect: false },
          { text: "Der gives point", isCorrect: true },
        ].map((option, index) => (
          <TouchableOpacity
            key={index}
            style={[
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Question4", { score, total: totalQuestions })}
        >
