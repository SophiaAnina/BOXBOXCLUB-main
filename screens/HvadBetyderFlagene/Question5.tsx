...
export default function Question5() {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={() => navigation.navigate('Question4')} style={styles.backButton}>
      ...
      <View style={styles.Spørgsmål}>
        <Text style={styles.questionTitle}>Spørgsmål 5</Text>
        <Text style={styles.questionText}>Hvad betyder et rødt flag under et løb?</Text>
      </View>
      <View style={styles.Questions}>
        {[
          { text: "Racet bliver midlertidigt stoppet", isCorrect: false },
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            // If the selected answer is correct, add 1 to score before navigating
            const isCorrect = [
              { text: "Racet bliver midlertidigt stoppet", isCorrect: false },
              { text: "Køreren er ude af løbet", isCorrect: false },
              { text: "Køreren skal skifte dæk", isCorrect: false },
              { text: "Sikkerhedsbilen er på banen", isCorrect: true },
            ][selectedAnswer]?.isCorrect;
            const finalScore = isCorrect ? score + 1 : score;
            navigation.navigate("Result", { score: finalScore, total: total });
          }}
        >
          <Text style={styles.nextButtonText}>Afslut</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
