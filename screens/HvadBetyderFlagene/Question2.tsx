...
export default function Question2() {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={() => navigation.navigate('Question1')} style={styles.backButton}>
      ...
      <View style={styles.Spørgsmål}>
        <Text style={styles.questionTitle}>Spørgsmål 2</Text>
      ...
      <View style={styles.Questions}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Question3", { score, total: totalQuestions })}
        >
